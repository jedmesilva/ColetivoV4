          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <button 
                ...
                onClick={() => setLocation(`/fund/${fundId}/governance`)}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl flex items-center justify-center bg-bege-transparent">
              ...
              <button 
                ...
                onClick={() => setLocation(`/fund/${fundId}/contribution-rate`)}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl flex items-center justify-center bg-bege-transparent">
              ...
              <button 
                ...
                onClick={() => setLocation(`/fund/${fundId}/distribution-settings`)}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div 
              ...
              <button 
                ...
                onClick={() => setLocation(`/fund/${fundId}/historico-objetivos`)}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl flex items-center justify-center bg-bege-transparent">
